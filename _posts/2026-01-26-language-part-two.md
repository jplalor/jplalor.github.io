...
[A few years ago](https://johnlalor.net/2024/08/language/) I wronte a post musing on the degree to which human interaction with LLMs would impact *human language*. 
...
Now, the next step is to see if we can identify preferred vocabulary across LLMs, see if they have distinct preferences in vocabulary choice, then compare that to humans to try to "predict" whether they are a ChatGPT or Gemini user. 
