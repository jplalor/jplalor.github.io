---
title: StatNLP: Essential Information Theory, Part 3
author: John Lalor
date: March 28, 2018
output: html
Category: StatNLP
...
After a bit of hiatus, it's time to wrap up the Information Theory introduction. In this post I'm going to talk about Mutual Information and KL-Divergence and why they're important. I'll look at why these two are important, how we get them from what we already know, and what we can do with them (with an example or two for good measure). After this post we can hit the ground running with the StatNLP book, woohoo!

## Mutual Information

### Quick Aside: Channel Capacity

## KL-Divergence

### Less Quick Aside: Cross Entropy
